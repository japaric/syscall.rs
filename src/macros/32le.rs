...
macro_rules! syscall {
    ($nr:ident, u64, $a1:expr)
        => ( ::sc::syscall2(
                ::sc::nr::$nr,
                $a1 as usize, ($a1 >> 32) as usize) );

    ($nr:ident, u64, $a1:expr, u64, $a2:expr)
        => ( ::sc::syscall4(
                ::sc::nr::$nr,
                $a1 as usize, ($a1 >> 32) as usize,
                $a2 as usize, ($a2 >> 32) as usize) );
